...
LEGAL_SYNONYMS: dict[str, list[str]] = {
    ...
    "evicted": ["eviction", "tenant", "landlord"],
    ...
    "polluted": ["pollution", "environment", "emission"],
    "polluting": ["pollution", "environment", "emission"],
    ...
    "cheated": ["cheating", "fraud", "misrepresentation"],
    "robbed": ["robbery", "theft", "criminal"],
    "stolen": ["theft", "robbery", "criminal"],
...
ISSUE_KEYWORDS: dict[str, list[str]] = {
    ...
    "Environmental Law": [
        "environment", "pollution", "polluted", "polluting", "forest",
        "wildlife", "ngt", "green tribunal", "waste", "emission",
        "ecological", "climate", "deforestation", "contamination",
        "contaminated", "toxic", "hazardous", "smog", "air quality",
    ],
    "Family Law": [
